...
<body>
	...
	<main class="full-width-main">
		<h1 class="splashed-heading" title="Not to be confused with Echoes — those don't exist in this reality.">Fragments</h1>
		<div title="Better get searching.">The best things have to be found.</div>

		<div id="fragments-canvas" data-unsearchable>
			<div id="dummy-fragment"></div>
			...
			<div>Fragments, twinkling like forgotten stars of the Abyss.</div>
			<div>The waking edge, where reality bleeds and dreams die.</div>
			<div>… demand to be put into hypnagogia immediately and indefinitely.</div>
			<div>All fear the Tearing, all run from the Tearing, for-</div>
			<div>Kept in line by the bloodied edge of failure.</div>
			<div>Walking with the dead makes you feel alive.</div>
			<div>Where was the part where [I] grew up?</div>
			<div>Is that the future so bright or the radiation sickness?</div>
			<div>The fire's brighter than all of our futures, somehow.</div>
			<div>Eat the devil or there's nothing you can do.</div>
			<div>[We] should be growing up, but instead [We]'re growing old.</div>
			<div>!</div>
			<div>Mayday. Mayday. Out.</div>
			<div><em>Click.</em></div>
			<div>ᓚᘏᗢ</div>
			<!-- I love SVGs -->
			<svg class="svg-main-text-colored" height="90" viewBox="0 0 73 41" xmlns="http://www.w3.org/2000/svg">
			...
			<svg class="svg-main-text-colored" height="24" viewBox="0 0 13339 6000" xmlns="http://www.w3.org/2000/svg" style="fill-rule:evenodd;text-rendering:geometricPrecision;image-rendering:optimizeQuality;clip-rule:evenodd;shape-rendering:geometricPrecision" >
